export default  [
...

    {
        ...
        desc: 'An AI tool that generates high-quality images based on user-provided descriptions or prompts.',
        category: 'Image Generation',
        icon: 'https://cdn-icons-png.flaticon.com/128/2921/2921222.png',
        slug: 'ai-image-generator',
        aiPrompt: 'Generate an image based on the provided description. Ensure it aligns with the input context and format output as a downloadable image URL or display inline.',
        form: [
            {
                label: 'Enter your image description or prompt',
                field: 'textarea',
                name: 'imagePrompt',
                required: true
            },
            {
                ...
                field: 'dropdown',
                name: 'imageSize',
                options: ['Small (512x512)', 'Medium (1024x1024)', 'Large (1792x1024)'],
                required: true
            },
            {
                label: 'Specify any additional styles or details (Optional)',
                field: 'textarea',
